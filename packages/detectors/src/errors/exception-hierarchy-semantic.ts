/**
 * Exception Hierarchy Detector - SEMANTIC VERSION
 * 
 * Language-agnostic detector that finds exception/error handling patterns
...
export class ExceptionHierarchySemanticDetector extends SemanticDetector {
  readonly id = 'errors/exception-hierarchy';
  readonly name = 'Exception Hierarchy Detector';
  readonly description = 'Learns exception and error handling patterns from your codebase';
...
export function createExceptionHierarchySemanticDetector(): ExceptionHierarchySemanticDetector {
  return new ExceptionHierarchySemanticDetector();
}
