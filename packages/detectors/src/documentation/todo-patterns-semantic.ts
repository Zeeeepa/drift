/**
 * Todo Patterns Detector - SEMANTIC VERSION
 * 
 * Language-agnostic detector that finds TODO/FIXME comment patterns
...
export class TodoPatternsSemanticDetector extends SemanticDetector {
  ...
  protected createPatternViolation(
    ...
    return {
      ...
      message: `Inconsistent TODO pattern: using '${match.contextType}' but project primarily uses '${dominantPattern.contextType}'`,
      expected: dominantPattern.contextType,
      actual: match.contextType,
      explanation: `Your project uses '${dominantPattern.contextType}' for TODO comments in ${dominantPattern.percentage.toFixed(0)}% of cases ` +
...
export function createTodoPatternsSemanticDetector(): TodoPatternsSemanticDetector {
  return new TodoPatternsSemanticDetector();
}
