/**
 * Import Ordering Semantic Detector
 * 
 * Language-agnostic detector that finds import ordering patterns
...
export class ImportOrderingSemanticDetector extends SemanticDetector {
  ...
  protected createPatternViolation(
    ...
    return {
      ...
      message: `Inconsistent import ordering pattern: using '${match.contextType}' but project primarily uses '${dominantPattern.contextType}'`,
      expected: dominantPattern.contextType,
      actual: match.contextType,
      explanation: `Your project uses '${dominantPattern.contextType}' for import ordering in ${dominantPattern.percentage.toFixed(0)}% of cases ` +
...
export function createImportOrderingSemanticDetector(): ImportOrderingSemanticDetector {
  return new ImportOrderingSemanticDetector();
}
