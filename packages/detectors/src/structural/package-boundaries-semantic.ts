/**
 * Package Boundaries Semantic Detector
 * 
 * Language-agnostic detector that finds package boundary patterns
...
export class PackageBoundariesSemanticDetector extends SemanticDetector {
  ...
  protected createPatternViolation(
    ...
    return {
      ...
      message: `Inconsistent package boundary pattern: using '${match.contextType}' but project primarily uses '${dominantPattern.contextType}'`,
      expected: dominantPattern.contextType,
      actual: match.contextType,
      explanation: `Your project uses '${dominantPattern.contextType}' for package boundaries in ${dominantPattern.percentage.toFixed(0)}% of cases ` +
...
export function createPackageBoundariesSemanticDetector(): PackageBoundariesSemanticDetector {
  return new PackageBoundariesSemanticDetector();
}
