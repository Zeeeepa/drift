/**
 * Module Boundaries Semantic Detector
 * 
 * Language-agnostic detector that finds module boundary patterns
...
export class ModuleBoundariesSemanticDetector extends SemanticDetector {
  ...
  protected createPatternViolation(
    ...
    return {
      ...
      message: `Inconsistent module boundary pattern: using '${match.contextType}' but project primarily uses '${dominantPattern.contextType}'`,
      expected: dominantPattern.contextType,
      actual: match.contextType,
      explanation: `Your project uses '${dominantPattern.contextType}' for module boundaries in ${dominantPattern.percentage.toFixed(0)}% of cases ` +
...
export function createModuleBoundariesSemanticDetector(): ModuleBoundariesSemanticDetector {
  return new ModuleBoundariesSemanticDetector();
}
