/**
 * Query Patterns Detector - SEMANTIC VERSION
 * 
 * Language-agnostic detector that finds query patterns
...
export class QueryPatternsSemanticDetector extends SemanticDetector {
  readonly id = 'data-access/query-patterns';
  readonly name = 'Query Patterns Detector';
  readonly description = 'Learns query patterns from your codebase';
  ...
  protected createPatternViolation(
    ...
    return {
      ...
      explanation: `Your project uses '${dominantPattern.contextType}' for queries in ${dominantPattern.percentage.toFixed(0)}% of cases ` +
...
export function createQueryPatternsSemanticDetector(): QueryPatternsSemanticDetector {
  return new QueryPatternsSemanticDetector();
}
