/**
 * Validation Patterns Detector - SEMANTIC VERSION
 * 
 * Language-agnostic detector that finds validation patterns
...
export class ValidationSemanticDetector extends SemanticDetector {
  readonly id = 'data-access/validation';
  ...
  protected createPatternViolation(
    ...
    return {
      ...
      explanation: `Your project uses '${dominantPattern.contextType}' for validation in ${dominantPattern.percentage.toFixed(0)}% of cases ` +
...
export function createValidationSemanticDetector(): ValidationSemanticDetector {
  return new ValidationSemanticDetector();
}
