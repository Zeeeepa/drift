/**
 * Repository Pattern Detector - SEMANTIC VERSION
 * 
 * Language-agnostic detector that finds repository patterns
...
export class RepositoryPatternSemanticDetector extends SemanticDetector {
  ...
  readonly description = 'Learns repository patterns from your codebase';
  ...
  protected createPatternViolation(
    ...
    return {
      ...
      explanation: `Your project uses '${dominantPattern.contextType}' for repository patterns in ${dominantPattern.percentage.toFixed(0)}% of cases ` +
